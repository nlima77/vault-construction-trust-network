...
A static, front-end-only demonstration of the **Vault AI** product — an AI-organized construction document intelligence platform with tamper-evident proof metadata.
...
2. **Review the Project Overview.** Check the roof replacement profile at 123 Sample Ave.
