# Original Vault AI / OP Vault Attribution Notes

## Identified original project

- GitHub: https://github.com/pashpashpash/vault-ai
- Website: https://vault.pash.city/
- Docs: https://docs.vault.pash.city/
- X/Twitter profile identified: https://x.com/VaultLLM
- Public contact found in project materials: `nik+vault@nugbase.com`

## GitHub repository facts captured

- Repository name: `pashpashpash/vault-ai`
...
- Primary language shown: JavaScript
- Default branch shown: `master`
- License shown: MIT License
- Original copyright notice in license: `Copyright (c) 2023 pashpashpash`
...
If we fork, copy, modify, or distribute any original OP Vault / Vault AI code:
